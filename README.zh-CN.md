...
> 其他 agent（Cursor / Codex / Gemini）见 [`docs/install.zh-CN.md`](./docs/install.zh-CN.md)。
...
| Cursor / Codex / Gemini | 🟡 通用拷贝 | 拷 `skills/codoop-flow/` 目录，见 [`docs/install.zh-CN.md`](./docs/install.zh-CN.md) |
